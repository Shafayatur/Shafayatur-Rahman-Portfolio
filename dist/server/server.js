...
import { H3Event, toResponse, getRequestURL } from "h3-v2";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DPlk9k1T.js");
...
const manifest = {
  "bd8f4ae5c7b8bba34c01b36b09547a49d59ee972c15cc0c48d23861f962c3893": {
    functionName: "getPortfolioData_createServerFn_handler",
    importer: () => import("./assets/portfolio-data-CV2u7qsB.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-YostZCmb.js").then((n) => n.r),
